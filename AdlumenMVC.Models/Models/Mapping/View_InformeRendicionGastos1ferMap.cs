...
{
    public class View_InformeRendicionGastos1ferMap : EntityTypeConfiguration<View_InformeRendicionGastos1fer>
    {
        public View_InformeRendicionGastos1ferMap()
        {
            // Primary Key
            this.HasKey(t => new { t.IdProyecto, t.Ejecutor, t.Pais, t.ObjetivoProposito, t.ObjetivoResultado, t.ObjetivoActividad, t.IdPresupuestoActividad, t.Periodo_id, t.Periodo_Movimiento, t.IdPartidaGasto, t.Partida_Gasto });
            ...
            this.ToTable("View_InformeRendicionGastos1fer");
