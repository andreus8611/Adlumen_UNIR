...
{
    public class View_saldoppto_resultado_tipoMap : EntityTypeConfiguration<View_saldoppto_resultado_tipo>
    {
        public View_saldoppto_resultado_tipoMap()
        {
            // Primary Key
            ...
            this.ToTable("View_saldoppto_resultado_tipo");
