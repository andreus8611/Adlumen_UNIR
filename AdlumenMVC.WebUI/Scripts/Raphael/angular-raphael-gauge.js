    ...
    .directive('raphaelGauge', function() {
        return {
          ...
          controller: function($scope, $element) {
            ...
            var text = paper.text(radius / 2, radius / 2, "")
                  .attr({
                      'font-size': radius / 8,
                      "stroke": options.textColor,
                      "fill": options.textColor
            ...
            $scope.$watch('config.text', function (newValue, oldValue) {
                ...
                options.text = $scope.config.text;
            ...
            $scope.$watch('config.value', function() {
                ...
                options.arcColor = $scope.config.arcColor;
              ...
              newArc.rotate(0, 100 ,100).animate({
                  arc: [radius / 2, radius / 2, (options.value > 100 ? 100 : options.value), 100, radius * 0.425]
