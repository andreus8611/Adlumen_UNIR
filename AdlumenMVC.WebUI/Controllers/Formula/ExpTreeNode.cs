                ...
                case NodeType.Literal:
                    {
                        ...
                        {
                            ErrorException Er = new ErrorException("La variable " + this._value.ToString() + " esta en el lugar incorrecto");
                            ret_val = false;
                            throw Er;
                            //return false;
                        }
                ...
                case NodeType.Symbol:
                    {
                        ...
                        if (this._value == INVALID)
                        {
                            ErrorException Er = new ErrorException("Simbolo no permitido o fórmula mal escrita"); //+ this._symbol
                            ret_val = false;
                            throw Er;
                            //return false;
                        }
                ...
                case NodeType.Operator:
                    {
                        ...
                        {
                            ErrorException Er = new ErrorException("Operador " + this._value.ToString() + " no está en el lugar correcto");
                            ret_val = false;
                            throw Er;
                            //return false;
                        }
